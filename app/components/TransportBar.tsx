...
export function TransportBar({
  ...
  return (
    <div className="h-16 border-b border-zinc-200 flex items-center px-4 md:px-6 gap-2 md:gap-4 bg-white shrink-0 z-10 shadow-sm relative overflow-x-auto">
      <button className="md:hidden p-2 text-zinc-400 hover:text-zinc-800" onClick={onShowLibrary} title="Show Library" aria-label="Show library">
      ...
      <div className="ml-auto flex items-center gap-1 md:gap-2 bg-zinc-50 border border-zinc-200 rounded-lg p-1 shrink-0">
        <button
          onClick={onZoomOut}
          className="w-8 h-8 md:w-6 md:h-6 flex items-center justify-center rounded text-zinc-500 hover:bg-zinc-200 hover:text-zinc-800 transition"
          title="Zoom Out"
          aria-label="Zoom out"
        >
      ...
      <button className="md:hidden p-2 text-zinc-400 hover:text-zinc-800 shrink-0" onClick={onShowEditor} title="Show Editor" aria-label="Show editor">
